...
\paragraph{Special case}: when all points of $L$ are in the same plane, we can use the function \textbf{cvx\_hull3dcoplanar(L,n)} where $n$ is a vector orthogonal to the plane. This function returns a facet (list of 3d points).
