...
\begin{itemize}
    \item \opt{color}: String defining the label color, initialized to the current label color.
    \item \opt{pos}: A string defining the position of the label relative to the anchor point (as in 2d: "N", "NW", "W", ...), initialized to the current style of the labels.
