...
\paragraph{Cas particulier}: lorsque tous les points de $L$ sont dans un même plan, on peut utiliser la fonction \textbf{cvx\_hull3dcoplanar(L,n)} où $n$ est un vecteur orthogonal au plan. Cette fonction renvoie une facette (liste de points 3d).
...
local g = graph3d:new{window={-3,3,-3.25,3.25}, margin={0,0,0,0}, viewdir=perspective("central",20,60), bg="LightGray", size={10,10}}
