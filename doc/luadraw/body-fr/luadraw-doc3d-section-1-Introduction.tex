...
\subsection{Modes de projection}

Par défaut \emph{luadraw} utilise la projection orthographique (projection orthogonale l'écran), celle-ci est définie par deux angles qui dont donnés à l'option \emph{viewdir} lors de la création, ou bien à la méthode \emph{g:Setviewdir()}.

Il y a trois autres modes de projection possible, mais qui ne sont pas des projections orthogonales:
\begin{itemize}
...
g:Show()
\end{luadraw}
\captionof{figure}{Modes de projection}
\end{center}
