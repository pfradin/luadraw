...
\def\luadrawTkzDir{tkz3d/}% sauvegarde des fichiers *.tkz dans le sous-dossier tkz3d
...
\onehalfspacing
\newminted{Lua}{bgcolor=Beige,ignorelexererrors=true,linenos,numbersep=6pt,breaklines,frame=single,fontsize=\footnotesize}%
...
\begin{itemize}
    \item \opt{mode=0/1/2/3/4/5} : définit le mode de représentation.
        \begin{itemize}
        ...
        \end{itemize}
        \item \opt{contrast} : c'est un nombre qui vaut 1 par défaut. Ce nombre permet d'accentuer ou diminuer la nuance des couleurs des facettes dans les modes 3, 4 et 5.
